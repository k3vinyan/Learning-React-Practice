...
const friedChickenRecipe = {
    ...
    steps,
    ingredients,
    image: './images/fried-chicken-in-baskets_800.jpg'
}
...
const chickenImage = recipeImage(friedChickenRecipe);
const chickenName = recipeName(friedChickenRecipe);
const chickenIngredients = recipeIngredients(friedChickenRecipe);
const chickenSteps = recipeSteps(friedChickenRecipe);



const RecipeComponent = (image, name, ingredients, steps) => 
...
const chickenComponent = RecipeComponent(chickenImage, chickenName, chickenIngredients, chickenSteps)

console.log(chickenComponent)
